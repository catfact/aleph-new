...
fract32 add_fr1x32(fract32 _x, fract32 _y) { return _x + _y; }

/* Performs 32-bit subtraction of the two input parameters (_x-_y). */
fract32 sub_fr1x32(fract32 _x, fract32 _y) { return _x - _y; }
...
// abs
fract32 abs_fr1x32(fract32 x) { return (x > 0 ? x : (-1 * x)); }
...
// minimum
fract32 min_fr1x32(fract32 _x, fract32 _y) { return (_x > _y ? _y : _x); }

// maximum
fract32 max_fr1x32(fract32 _x, fract32 _y) { return (_x > _y ? _x : _y); }

// left shift (with sign extension)
fract32 shl_fr1x32(fract32 _x, int _y) { return _x << _y; }

// clipping variant for compatibility only
fract32 shl_fr1x32_clip(fract32 _x, int _y) { return _x << _y; }

// right shift (with sign extension)
fract32 shr_fr1x32(fract32 _x, int _y) { return _x >> _y; }

// clipping variant for compatibility only
fract32 shr_fr1x32_clip(fract32 _x, int _y) { return _x >> _y; }
